...
- General heuristics:
  ...
  - [x] File is not empty and has at least 4 bytes for processing purposes
  - [x] That decompressed data is not empty
  - [x] Whitespace-only files
  - [x] compression formats complete header and truncation check
